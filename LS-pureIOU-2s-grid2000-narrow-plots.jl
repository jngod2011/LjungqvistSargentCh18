...
begin
    ...
    Λ1=LS_pureIOU_2s_2000_narrow_saved[3]
    tbl2=LS_pureIOU_2s_2000_narrow_saved[4]
end;
...
begin
    ...
    plot!((-0.01:0.0001:0.0025)*0,-0.01:0.0001:0.0025,color=:black,label="")
...
begin
    plot(aassets[1,2:1920],LF[1][2:1920],label="(LS)",color=:black)
    plot!(aassets[2,2:1920],LF[2][2:1920],label="",color=:black)
end
